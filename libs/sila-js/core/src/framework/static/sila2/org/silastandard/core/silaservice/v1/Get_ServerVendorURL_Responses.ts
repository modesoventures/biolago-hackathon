...
export interface Get_ServerVendorURL_Responses {
  'ServerVendorURL'?: (_sila2_org_silastandard_String | null);
}

export interface Get_ServerVendorURL_Responses__Output {
  'ServerVendorURL': (_sila2_org_silastandard_String__Output | null);
}
