...
export interface Get_ServerUUID_Responses {
  'ServerUUID'?: (_sila2_org_silastandard_String | null);
}

export interface Get_ServerUUID_Responses__Output {
  'ServerUUID': (_sila2_org_silastandard_String__Output | null);
}
