...
export interface Get_ServerName_Responses {
  'ServerName'?: (_sila2_org_silastandard_String | null);
}

export interface Get_ServerName_Responses__Output {
  'ServerName': (_sila2_org_silastandard_String__Output | null);
}
